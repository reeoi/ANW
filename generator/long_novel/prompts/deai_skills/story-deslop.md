...
加载anti-ai-writing.md 的「第二部分：系统性去AI三遍法」获取完整流程。三遍法与本 skill 的关系：
...
| 文件 | 何时加载 |
|------|----------|
| banned-words.md| 检测和替换禁用词时 |
| anti-ai-writing.md| **去AI味完整指南**：预防+三遍法+范例 |
